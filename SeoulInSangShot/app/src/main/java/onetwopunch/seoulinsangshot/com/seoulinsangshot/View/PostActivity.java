                        ...
                        AndroidNetworking.post(Constants.TEST_BASE_URL + "tupload")
                                ...
                                .getAsJSONObject(new JSONObjectRequestListener() {
                                    ...
                                    public void onResponse(JSONObject response) {
                                        ...
                                        //☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★
                                        //사진등록과 동시에 DetailActivity.bestList에 add시키기
                                        // DetailActivity.bestList.add(new Model_Best(id,area,encodedImage,deviceType,filter,season,simpleTime,content,formatDate));
                                        //☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★☆★
                                        finish();
                                    }
                                    @Override
